...
def test_unified_service():
    ...
    print(
        f"✅ Service has opportunity_intake_advisor_agent: {hasattr(service, 'opportunity_intake_advisor_agent')}"
    )
    print(
        f"✅ Service has opportunity_intake_creation_agent: {hasattr(service, 'opportunity_intake_creation_agent')}"
    )
