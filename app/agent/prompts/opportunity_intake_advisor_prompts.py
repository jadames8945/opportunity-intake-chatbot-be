...
- AI Component (if any)
- Preferred Platforms/Technologies: Ask with examples like "What platforms or technologies are preferred or required? For example: • AWS • Azure • Salesforce • AEM (Adobe Experience Manager) • Java • C# • Python • OpenAI.. If you have others, just let me know!"
